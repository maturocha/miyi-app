...
class Order extends Model
{
  ...
  public static function getDetailsByID($id) {
    return self::where('orders.id', '=', $id)
                ...
                ->select('products.id as id_product','products.name', 'products.type_product', 'order_details.quantity', 'order_details.price_unit', 'order_details.discount', 'order_details.price_final', 'order_details.id', 'order_details.weight')
