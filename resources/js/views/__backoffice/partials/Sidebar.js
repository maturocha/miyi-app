...
import brandLogoLight from '../../../../img/logos/logo-ligth.png';
import brandLogoDark from '../../../../img/logos/logo-dark.png';
...
function Sidebar(props) {
    ...
    const linkGroups = (authUser.type == 'superuser') ? [
        {
            name: 'Config',
            id: 'resources',
            links: [
    ...
    [
        {
            ...
            links: [
                ...
                },
                {
                    ...
                    icon: <AddIcon />,
                    path: NavigationUtils.route(
                        'backoffice.general.orders.create',
                    ),
                },
            ],
        },
