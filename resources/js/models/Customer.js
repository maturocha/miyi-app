...
export default class Customer {
    ...
    static async store(attributes) {
        const response = await axios.post('/api/v1/customers', attributes);
    ...
    static async update(id, attributes) {
        const response = await axios.patch(`/api/v1/customers/${id}`, attributes);
    ...
    static async restore(id) {
        const response = await axios.patch(`/api/v1/customers/${id}/restore`);
